...
DATA_URL = (
"/Users/KIIT/Downloads/streamlit/Motor_Vehicle_Collisions_-_Crashes.csv"
)

st.title("Motor Vechile Collisions in New York City")
st.markdown("This application is a Stramlit dashboard that can be used "
